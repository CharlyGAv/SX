  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-800 to-slate-900 flex flex-col items-center justify-center px-4 transition-all duration-500">
      <div className="text-center space-y-5 max-w-md mx-auto">
        ...
        <div className="space-y-0">
          <div className="flex justify-center">
            <img 
              ...
              className="h-04 md:h-11 object-contain"
            />
          </div>
        ...
        <button 
          onClick={onEnter}
          className="group bg-microformas-orange hover:bg-orange-600 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-3 mx-auto shadow-lg hover:shadow-xl transform hover:-translate-y-1"
        >
          <span>Ingresar</span>
